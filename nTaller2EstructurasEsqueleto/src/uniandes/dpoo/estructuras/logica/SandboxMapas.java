...
public class SandboxMapas {
	...
	public List<String> getValoresComoLista() {
		...
		Map<String, String> copiaMapa = new HashMap<>(mapaCadenas);

		List<String> retorno = new ArrayList<>(copiaMapa.values());
	...
	public List<String> getLlavesComoListaInvertida() {
		...
		List<String> retorno = new ArrayList<>(copiaMapa.keySet());
	...
	public String getPrimera() {
		if (mapaCadenas.isEmpty()) {
			return null; // El mapa está vacío, retorna null
		}

		String primeraCadena = null;

		for (String clave : mapaCadenas.keySet()) {
			if (primeraCadena == null || clave.compareTo(primeraCadena) < 0) {
				primeraCadena = clave;
			}
		}
	...
	public Collection<String> getLlaves() {
		...
		for (String clave : mapaCadenas.keySet()) {
			...
			llavesMayusculas.add(clave.toUpperCase());
		}
